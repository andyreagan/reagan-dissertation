...
\begin{figure}[tbp!]
  \centering
  \includegraphics[width=0.96\textwidth]{../philanthropy-distributions-reorganized/figures/figphdists001_noname.pdf}
  \caption[]{
...
\begin{figure}[tbp!]
  \centering
  \includegraphics[width=0.96\textwidth]{../philanthropy-distributions-reorganized/figures/KSvsXmin_inst_4_noname.pdf}
  \caption[]{
...
{\scriptsize
\input{../philanthropy-distributions-reorganized/paper/philanthropy-distributions.supplementary-inst-sideways}
}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.96\textwidth]{figures/extracted/scatter-LabMT-WK-ANEW.png}
  \caption[]{
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.45\textwidth]{figures/extracted/reply-fig1.png}
  \includegraphics[width=0.45\textwidth]{figures/extracted/warriner_fig1.png}
  \caption[]{
