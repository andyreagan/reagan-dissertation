...
afforded by the Computational Story Lab \footnote{footnotes working fine}.
...
In addition to testing for support of power law distributions using the MLE estimator \cite{clauset2009b}, I 
...
Words uncovered by our analysis suggest that responses to climate change news are predominantely from climate change activists rather than climate change deniers, indicating that Twitter is a valuable resource for the spread of climate change awareness.
\end{quote}
...
\begin{quote}
  ...
  (1) a misreading of our findings in [1];
...
---of which we explored the nuances in great detail in [1]
...
We find that \#BlackLivesMatter exhibits many informationally rich conversations,
