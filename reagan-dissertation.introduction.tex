...
The widely acknowledged six emotions identified by Paul Eckman are: happy, surprised, afraid, disgusted, angry, and sad.
...
Stanford Twitter Sentiment used emoticons the infer the sentiment of tweets for machine learning task evaluation, but this is essentially just testing the machine learning methods for word embedding performance with this type of free-form text. Final version for Saif claims to have done manual tagging.
...
\begin{table}
  {\tiny
    \begin{tabular}{l | l | l | l | l}
      ...
      STS-Test         & & \href{http://help.sentiment140.com/for-students}{Yes} & & \cite{giachanou2016like}  \\
...
\subsection{Benchmarking literature review}
...
This survey from Giachanou \etal provides an overview of methods used to quantify sentiment on Twitter.
The focus is on ML approaches, and no quantitative comparisons are made between the methods themselves.\\
...
Nevertheless, the comparisons made by Ribeiro \etal utilize a variety of methods, and provide measures of performance for all methods based on F1 scores.
...
In Chapter 3 we consider previous work that finds between one and 36 different plot types: cite{campbell2008a,harris1959basic,abbott2008cambridge,booker2006a,polti1921thirty}.
...
Toward Automatic Role Identification in Unannotated Folk Tales \cite{valls2014toward2}.
\begin{quote}
...
In \cite{piper2015novel}, computational analysis is applied to realize the potential of distant reading (see \cite{moretti2013}) to find and test scholarly insights.
...
With the same goals in pursuing the story shapes first elaborated by \cite{vonnegut1981}, in a series of blog posts \cite{jockers2016novel} lays out a strategy for generating emotional arcs and eventually finds six story types using hierarchical clustering.
Our work in Chapter 3 is an continuation of a very different core methodology that we first propose in \cite{dodds2015a}.
