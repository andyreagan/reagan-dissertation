...
\begin{abstract}
  ...
  issuing profound implications for our understanding of human behavior.
...
Finally, we utilize web-scale data from Twitter to study the limits of what social data can tell us about public health, forecasting mental illness, discourse around the protest movement of \#BlackLivesMatter and around climate change, and inferring hidden networks.
We conclude with a review of studies of complex systems that include: charitable donations to describe and model philanthropic behavior, the happiness of words in 10 languages to find a universal positivity bias, over 100 years of daily temperature data across the United States to explore patterns of change in the hottest and coldest days of the year, and Australian Rules Football games to find a continuous spectrum of game stories.
